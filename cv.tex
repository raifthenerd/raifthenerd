...
\definecolor{color0}{HTML}{212529}
\definecolor{color1}{HTML}{d6336c}
\definecolor{color2}{HTML}{495057}
...
\cventry{Dec 2023 --- Current}{ML Research Scientist}{TwelveLabs}{Seoul, Korea}{ML Modeling Team}{Contributed to the development of Marengo, a state-of-the-art video search model.}
...
\cvline{}{$^\dag$: equal contributions, $^\ast$: corresponding author(s).}
\subsection{Papers}
\cvlistitem{Minyoung~So$^{\dag\ast}$, Soo~Jung~Park$^{\dag}$, Dongin~Kim, \textbf{Seokjin~Han}, Hee~Jung~Koo, Taeyong~Kim, Min-Gi~Shin, Eun~Jeong~Lee$^{\ast}$ (2026).
  ...
  \emph{Computational and Structural Biotechnology Journal.} \href{https://doi.org/10.1016/j.csbj.2025.12.035}{\texttt{DOI:10.1016/j.csbj.2025.12.035}}}
