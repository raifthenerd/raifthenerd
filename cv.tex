...
\subsection{Paper}
\cvlistitem{\textbf{Seokjin~Han}$^{\dag\ast}$, Ji~Eun~Lee$^{\dag}$, Seolhee~Kang, Minyoung~So, Jin~Hee, Jang~Ho~Lee, Sunghyeob~Baek, Hyungjin~Jun, Tae~Yong~Kim and Yun-Sil~Lee$^{\ast}$ (2023).
